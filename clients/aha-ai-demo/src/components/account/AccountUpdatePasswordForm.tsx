        ...
        <div style={{
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div style={{display: "flex", flexDirection: "column", gap: "12px"}}>
                    ...
                    <TextField fullWidth label="Old Password" type="password" size="small" {...register("oldPassword")}
                               error={!!errors.oldPassword} helperText={errors.oldPassword?.message}/>

                    <TextField fullWidth label="Password" type="password" size="small" {...register("newPassword")}
                               error={!!errors.newPassword} helperText={errors.newPassword?.message}/>

                    <TextField fullWidth label="Password Confirmation" type="password"
                               size="small" {...register("passwordConfirmation")}
