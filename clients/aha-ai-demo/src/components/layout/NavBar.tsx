...
function NavBar() {
  ...
  return (
    <>
      ...
      >
        {!isLogin && (
          <Button variant={'contained'} onClick={signUpModal.open}>
            Sign Up
          </Button>
        )}
        {!isLogin && (
          <Button variant={'outlined'} onClick={signInModal.open}>
            Sign In
          </Button>
        )}
        {isLogin && (
      ...
      <TransitionsModal isOpen={signUpModal.isOpen} close={signUpModal.close}>
        <SignForm closeForm={signUpModal.close} mode={'signUp'} />
      </TransitionsModal>

      <TransitionsModal isOpen={signInModal.isOpen} close={signInModal.close}>
